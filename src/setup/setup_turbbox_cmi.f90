...
subroutine setpart(id,npart,npartoftype,xyzh,massoftype,vxyzu,polyk,gamma,hfact,time,fileprefix)
 ...
 use photoionize_cmi, only:inject_rad,monochrom_source,fix_temp_hii,treat_Rtype_phase
 use photoionize_cmi, only:photoionize_tree,nHlimit_fac,auto_opennode
 ...
 real    :: t_ff,rmsmach,v2i,turbfac,turbboxsize
 ...
 if (rms_mach > 0.) then
    ...
    turbboxsize = boxsize_setunifdis
