...
module setup
!
! This module sets up an ellipsoid with an envalope with sinks as clusters 
!
! :References: None
!
! :Owner: Cheryl Lau
...
subroutine setpart(id,npart,npartoftype,xyzh,massoftype,vxyzu,polyk,gamma,hfact,time,fileprefix)
 ...
 if (.not.in_iexist) then
    ...
    if (make_sinks) then
       ...
       h_acc_cgs    = 0.25*pc          ! accretion radius for new sink particles
       h_soft_sinksink_cgs = 0.25*pc   ! softening length between sink particles
