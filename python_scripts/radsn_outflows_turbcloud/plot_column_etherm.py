...
plot_mollweide(ax1,'sky_etherm_cloud_20_10_clrsink14_01350.dat',vmin,vmax,time_Myr)

ax2 = fig.add_subplot(323, projection='mollweide')
time_Myr, sdf = read_dump('cloud_20_10_clrsink14_04450')
plot_mollweide(ax2,'sky_etherm_cloud_20_10_clrsink14_04450.dat',vmin,vmax,time_Myr)

ax3 = fig.add_subplot(325, projection='mollweide')
time_Myr, sdf = read_dump('cloud_20_10_clrsink14_05000')
plot_mollweide(ax3,'sky_etherm_cloud_20_10_clrsink14_05000.dat',vmin,vmax,time_Myr)

ax4 = fig.add_subplot(322, projection='mollweide')
time_Myr, sdf = read_dump('cloud_20_10_clrsink14_06000')
plot_mollweide(ax4,'sky_etherm_cloud_20_10_clrsink14_06000.dat',vmin,vmax,time_Myr)

ax5 = fig.add_subplot(324, projection='mollweide')
time_Myr, sdf = read_dump('cloud_20_10_clrsink14_08000')
plot_mollweide(ax5,'sky_etherm_cloud_20_10_clrsink14_08000.dat',vmin,vmax,time_Myr)

ax6 = fig.add_subplot(326, projection='mollweide')
time_Myr, sdf = read_dump('cloud_20_10_clrsink14_09570')
plot_mollweide(ax6,'sky_etherm_cloud_20_10_clrsink14_09570.dat',vmin,vmax,time_Myr)
...
plt.savefig('column_etherm.png',dpi=200)
plt.savefig('column_etherm.pdf',format='pdf')
plt.show()
