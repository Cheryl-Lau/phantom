...
plot_mollweide(ax1,'2pc_maps/sky_density_cloud_20_10_clrsink14_01350.dat',vmin,vmax,time_Myr-t_SN)
...
plot_mollweide(ax2,'2pc_maps/sky_density_cloud_20_10_clrsink14_04450.dat',vmin,vmax,time_Myr-t_SN)

ax3 = fig.add_subplot(425, projection='mollweide')
time_Myr, sdf = read_dump('cloud_20_10_clrsink14_05000')
plot_mollweide(ax3,'2pc_maps/sky_density_cloud_20_10_clrsink14_05000.dat',vmin,vmax,time_Myr-t_SN)

ax4 = fig.add_subplot(427, projection='mollweide')
time_Myr, sdf = read_dump('cloud_20_10_clrsink14_09570')
plot_mollweide(ax4,'2pc_maps/sky_density_cloud_20_10_clrsink14_09570.dat',vmin,vmax,time_Myr-t_SN)
...
time_Myr, sdf = read_dump('cloud_20_10_clrsink14_01350')
plot_mollweide(ax5,'15pc_maps/sky_density_cloud_20_10_clrsink14_01350.dat',vmin,vmax,time_Myr-t_SN)
ax5.set_title('Within 15 pc radius', fontsize=18, pad=30)

ax6 = fig.add_subplot(424, projection='mollweide')
time_Myr, sdf = read_dump('cloud_20_10_clrsink14_04450')
plot_mollweide(ax6,'15pc_maps/sky_density_cloud_20_10_clrsink14_04450.dat',vmin,vmax,time_Myr-t_SN)

ax7 = fig.add_subplot(426, projection='mollweide')
time_Myr, sdf = read_dump('cloud_20_10_clrsink14_05000')
plot_mollweide(ax7,'15pc_maps/sky_density_cloud_20_10_clrsink14_05000.dat',vmin,vmax,time_Myr-t_SN)

ax8 = fig.add_subplot(428, projection='mollweide')
time_Myr, sdf = read_dump('cloud_20_10_clrsink14_09570')
plot_mollweide(ax8,'15pc_maps/sky_density_cloud_20_10_clrsink14_09570.dat',vmin,vmax,time_Myr-t_SN)
...
plt.savefig('column_density_sky.png',dpi=200)
plt.savefig('column_density_sky.pdf',format='pdf')
plt.show()
