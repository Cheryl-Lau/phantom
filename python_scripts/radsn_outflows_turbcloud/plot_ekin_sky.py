...
def plot_mollweide(ax,thetaphi_file,vmin_in,vmax_in,time_Myr):
    ...
    im = ax.pcolormesh(theta_mesh, phi_mesh, columnden, norm=colors.LogNorm(vmin=vmin_in,vmax=vmax_in), cmap='nipy_spectral')
    cbar = fig.colorbar(im, ax=ax, shrink=0.6, location='right')

    cbar.ax.set_ylabel(r'column kinetic energy $\mathrm{[erg\ cm^{-2}]}$', labelpad=15, rotation=270)
...
plot_mollweide(ax1,'2pc_maps/sky_ekin_cloud_20_10_clrsink14_01350.dat',vmin,vmax,time_Myr-t_SN)
...
plot_mollweide(ax2,'2pc_maps/sky_ekin_cloud_20_10_clrsink14_04450.dat',vmin,vmax,time_Myr-t_SN)

ax3 = fig.add_subplot(425, projection='mollweide')
time_Myr, sdf = read_dump('cloud_20_10_clrsink14_05000')
plot_mollweide(ax3,'2pc_maps/sky_ekin_cloud_20_10_clrsink14_05000.dat',vmin,vmax,time_Myr-t_SN)

ax4 = fig.add_subplot(427, projection='mollweide')
time_Myr, sdf = read_dump('cloud_20_10_clrsink14_09570')
plot_mollweide(ax4,'2pc_maps/sky_ekin_cloud_20_10_clrsink14_09570.dat',vmin,vmax,time_Myr-t_SN)
...
time_Myr, sdf = read_dump('cloud_20_10_clrsink14_01350')
plot_mollweide(ax5,'15pc_maps/sky_ekin_cloud_20_10_clrsink14_01350.dat',vmin,vmax,time_Myr-t_SN)
ax5.set_title('Within 15 pc radius', fontsize=18, pad=30)

ax6 = fig.add_subplot(424, projection='mollweide')
time_Myr, sdf = read_dump('cloud_20_10_clrsink14_04450')
plot_mollweide(ax6,'15pc_maps/sky_ekin_cloud_20_10_clrsink14_04450.dat',vmin,vmax,time_Myr-t_SN)

ax7 = fig.add_subplot(426, projection='mollweide')
time_Myr, sdf = read_dump('cloud_20_10_clrsink14_05000')
plot_mollweide(ax7,'15pc_maps/sky_ekin_cloud_20_10_clrsink14_05000.dat',vmin,vmax,time_Myr-t_SN)

ax8 = fig.add_subplot(428, projection='mollweide')
time_Myr, sdf = read_dump('cloud_20_10_clrsink14_09570')
plot_mollweide(ax8,'15pc_maps/sky_ekin_cloud_20_10_clrsink14_09570.dat',vmin,vmax,time_Myr-t_SN)
...
plt.savefig('column_ekin_sky.png',dpi=200)
plt.savefig('column_ekin_sky.pdf',format='pdf')
plt.show()
